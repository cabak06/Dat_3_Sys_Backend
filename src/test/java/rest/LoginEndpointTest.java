...
public class LoginEndpointTest {
  ...
  public void testAutorizedUserCannotAccesAdminPage() {
    ...
    given()
            ...
            .header("x-access-token", securityToken)
            .when()
            .get("/user/admin").then() //Calling admin endpoint as user
            .statusCode(401);
  }
  ...
  public void testAutorizedAdminCannotAccesUserPage() {
    ...
    given()
            ...
            .header("x-access-token", securityToken)
            .when()
            .get("/user/user").then()  //Calling user endpoint as admin
            .statusCode(401);
  }
  ...
  public void testRestForMultiRole1() {
    ...
    given()
            ...
            .header("x-access-token", securityToken)
            .when()
            .get("/user/admin").then() //Calling admin endpoint
            .statusCode(200)
  ...
  public void testRestForMultiRole2() {
    ...
    given()
            ...
            .header("x-access-token", securityToken)
            .when()
            .get("/user/user").then() //Calling user endpoint
            .statusCode(200)
